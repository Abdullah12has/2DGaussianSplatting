...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=True, resolution_scales=[1.0]):
        ...
        if args.use_colmap and os.path.exists(os.path.join(args.source_path, args.colmap_folder)):
            ...
            scene_info = sceneLoadTypeCallbacks["Blender"](args.source_path, args.white_background, args.eval, images_folder=args.images)
        else:
    ...
    def save(self, iteration):
        ...
        self.gaussians.save_ply_and_exposure(os.path.join(point_cloud_path, "point_cloud.ply"))
